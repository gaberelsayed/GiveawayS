...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    .addComponents(
        ...
        new MessageButton()
          ...
          .setStyle('LINK')       
 .setURL(`https://discord.com/api/oauth2/authorize?client_id=900628889452314674&permissions=8&scope=applications.commands%20bot`),
 ...
 .setURL(`https://github.com/Aim2339/GiveawayS/`),
    ...
    interaction.reply({ content: 'Here are all the links related to the bot!', components: [row, row2, row3] });
  }
}
